...
def load_data():
    ...
    df_all_breeds = pd.read_pickle("df_all_breeds.pkl")
    emails = pd.read_csv("emails.csv")
    return df_all_breeds, emails
...
# Function to process email text (for Naive Bayes email classifier)
def process_email(text):
    """
    Processes the given email text by converting it to lowercase and splitting it into words.
